...
const mockMovie: MovieDetails = {
  ...
  test('отображает информацию фильма', () => {
    ...
    expect(getByAltText('Тестовый фильм')).toHaveAttribute('src', 'test-poster.jpg');
    expect(getByText((_, element) => element!.textContent === 'Тестовый фильм - 2021')).toBeInTheDocument();
    ...
    expect(getByText('https://example.com')).toHaveAttribute('href', 'https://example.com');
  });
